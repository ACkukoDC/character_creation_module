...
def attack(char_name: str, char_class: str) -> str:
    """Урон от атаки в зависимости от выбранного персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блок урона в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Специальное умение в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренировка. Выбор одного из трех действий персонажа"""
    if char_class == 'warrior':
